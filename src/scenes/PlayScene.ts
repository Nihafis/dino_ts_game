...
class PlayScene extends GameScene {
    ...
    createScore() {
        ...
        this.highScoreText = this.add.text(this.scoreText.getBounds().left - 20, 9, "00000", {
            fontSize: 20,
            fontFamily: "Arial",
            color: "#535353",
            resolution: 5
    ...
    spawnObstacle() {
        const obstclesCount = PRELOAD_CONFIG.cactusesCount + PRELOAD_CONFIG.birdCount
        const obstacleNum = Math.floor(Math.random() * obstclesCount) + 1;
        // const obstacleNum = 7
        ...
        if (obstacleNum > PRELOAD_CONFIG.cactusesCount) {
            const enemyPossibleHeight = [20, 70, 90];
